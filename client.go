...
// NewGetDepositAddresService init listing deposits service
func (c *Client) NewGetDepositAddresService() *GetDepositAddresService {
	return &GetDepositAddresService{c: c}
}
